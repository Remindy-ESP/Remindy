...
export const usersApi = {
  ...
  unban(id: string) {
    return apiClient.post(`/admin/users/${id}/unban`).then(r => r.data);
  },

  verifyEmail(id: string) {
    return apiClient.post(`/admin/users/${id}/verify-email`).then(r => r.data);
  },

  forceMfa(id: string) {
    return apiClient.post(`/admin/users/${id}/force-mfa`).then(r => r.data);
  },
