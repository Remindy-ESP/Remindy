                ...
                <Grid size={{ xs: 12, md: 8 }}>
                    <Paper sx={{ p: 3 }}>
                        ...
                        <InfoRow label="Dernière connexion">
                            <Typography variant="body2">{fmtDate(user.lastLoginAt)}</Typography>
                        </InfoRow>
                        ...
                        <Paper sx={{ p: 3 }}>
                            ...
                            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.5 }}>
                                ...
                                <Button
                                    ...
                                    onClick={() => setDialog({ type: 'resetPassword', open: true })}
                                    fullWidth
                                >
                                ...
                                {!user.emailVerified && (
                                    <Button
                                        ...
                                        onClick={() => setDialog({ type: 'verifyEmail', open: true })}
                                        fullWidth
                                    >
                                        Vérifier l'email
                                    </Button>
                                ...
                                <Button
                                    ...
                                    onClick={() => setDialog({ type: 'revokeSessions', open: true })}
                                    fullWidth
                                >
