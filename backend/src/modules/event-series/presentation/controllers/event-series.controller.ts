...
export class EventSeriesController {
  ...
  async create(@Body() createDto: CreateEventSeriesDto): Promise<EventSeriesResponseDto> {
  ...
  async generateEvents(
    ...
    return await this.generateEventsUseCase.execute(id, startDate, endDate, maxOccurrences);
  }
}
