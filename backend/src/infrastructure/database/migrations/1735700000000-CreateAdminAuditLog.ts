...
export class CreateAdminAuditLog1735700000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      DO $$ BEGIN
        ALTER TABLE "admin_audit_log" ADD CONSTRAINT "fk_admin_audit_log_actor"
    ...
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "idx_admin_audit_log_success" ON "admin_audit_log"("success")`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "idx_admin_audit_log_before_gin" ON "admin_audit_log" USING GIN ("before")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "idx_admin_audit_log_after_gin" ON "admin_audit_log" USING GIN ("after")`,
    );
  }
